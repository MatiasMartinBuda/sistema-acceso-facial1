...
# CONFIGURACIÓN
# =====================================================
# Igual que en tu settings.py / config.py, esto NO debe subirse a git.
# Podés cargarlo desde tu settings.json existente en vez de una env var.
...
class AgenteConversacionalPortero:
    ...
    def __init__(self, api_key: str = ANTHROPIC_API_KEY):
        if not api_key:
            raise ValueError(
                "Falta ANTHROPIC_API_KEY. Configurala como variable de entorno "
                "o cargala desde tu settings.json."
            )
